...
## Höherer Preis = mehr Karat + ?
Okay, jedes Kind weiß: je mehr Karat, desto besser. Beim Blick auf die Daten fallen aber weitere Spalten auf: die Einteilung für "cut" geht von "fair" bis "ideal", die für clarity von "worst" bis "best", die für "color" ebenfalls. Die Vermutung liegt nahe, dass eine derartige Einteilung Auswirkungen auf den Preis hat. Aber wie ist das Zusammenspiel?

Schauen wir erst einmal, wie sehr der Preis von den Karat abhängt, d. h., wie viel Varianz im Preis durch Karat erklärt werden kann:

```{r}
ggplot(diamonds,aes(x=carat,y=price)) + geom_point()
```

Geplottet sieht das schonmal vielversprechend aus.

...


... und die anderen Faktoren?
Plotten wir die doch mal dazu:
(Farbe haben wir weiter oben in der Grafik schon gesehen - sieht vielversprechend aus!)
...
Das sieht bei "cut" ziemlich verwirrend aus, aber "clarity" sieht schön klar (ha ha...) aus. Und statistisch?
